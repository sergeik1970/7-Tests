            ...
            <div className={styles.container}>
                <div className={styles.content}>
                    ...
                    <p className={styles.subtitle}>
                        Современная платформа для создания онлайн-тестов, подходящая как для образовательных учреждений, 
                        так и для корпоративного обучения. Получайте детальную аналитику и отчеты.
                    </p>
                    ...
                    <div className={styles.mockup}>
                        ...
                        <div className={styles.mockupContent}>
                            ...
                            <div className={styles.mockupQuestion}>
                                ...
                                {showCongrats && (
                                    <div className={styles.congratsAnimation}>
                                        🎉 Молодец!
                                    </div>
                                )}
                            </div>
